...
namespace XLite\Module\Shofi\FreshMail\API;
 ...
 *  @since  2012-06-14
 */
class FreshmailRestApi extends \XLite\Base\Singleton
{
        ...
        if ($this->httpCode != 200) {
            ...
            if (is_array($this->errors)) {
                foreach ($this->errors as $error) {
                    throw new \XLite\Core\Exception($error['message'], $error['code']);
                }
            }
        }

//        if (is_array($this->response) == false) {
//            throw new \XLite\Core\Exception('Invalid json response');
//        }
